...
export const validationShema = yup
	.object()
	.shape({
		name: yup
			.string()
			.required('Заполните поле!')
			.matches(nameRegex, 'Имя должно содержать латинские буквы!')
		...
		password: yup
			...
			.matches(
				passwordRegex,
				'Пароль должен содержать хотя бы одну строчную и заглавную букву, а также специальный символ'
			),
		confirmpassword: yup
			.string()
			.required('Заполните поле!')
